...
export const metadata: Metadata = {
  ...
  description:
    'Read what our clients say about My Garden Space. 200+ satisfied customers, 4.9-star rating. Customer reviews and testimonials from homeowners and businesses in Bangalore.',
  keywords: [
    'My Garden Space reviews',
    'gardening services reviews Bangalore',
    'landscaping testimonials',
    'customer feedback',
    'client reviews',
  ],
  openGraph: {
    title: 'Testimonials | My Garden Space',
    description:
      'Read what our 200+ satisfied clients say about our gardening and landscaping services.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'My Garden Space Testimonials',
      },
    ],
  },
  twitter: {
    ...
    title: 'Testimonials | My Garden Space',
    description:
      'Read what our clients say about our gardening and landscaping services.',
  },
  alternates: {
...
// JSON-LD schemas for testimonials page
const testimonialsPageBreadcrumbs = generateBreadcrumbSchema([
  { name: 'Home', url: '/' },
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(testimonialsPageBreadcrumbs),
        }}
      />
      <script
        type="application/ld+json"
