...
export const metadata: Metadata = {
  title: 'Plant Rental Services | Events, Offices & Homes',
  description:
    'Rent beautiful plants for events, offices, homes, and exhibitions in Bangalore. Flexible durations, delivery, setup, and maintenance included. Transform any space with greenery!',
  keywords: [
    'plant rental Bangalore',
    'indoor plant rental',
    'office plant rental',
    'event plant rental',
    'wedding plant decoration',
    'corporate plant rental',
    'exhibition plant rental',
    'plant hire Bangalore',
  ],
  openGraph: {
    title: 'Plant Rental Services | My Garden Space',
    description:
      'Rent beautiful plants for events, offices, homes with delivery and maintenance included.',
    url: `${SITE_URL}/plant-rental`,
    type: 'website',
    images: [
      {
        url: '/og-image.jpg',
        width: 1200,
        height: 630,
        alt: 'Plant Rental Services - My Garden Space',
      },
    ],
  },
  twitter: {
    ...
    title: 'Plant Rental Services | My Garden Space',
    description:
      'Rent beautiful plants for events, offices, homes in Bangalore.',
  },
  alternates: {
    canonical: `${SITE_URL}/plant-rental`,
  },
};

// JSON-LD schemas for plant rental page
const plantRentalBreadcrumbs = generateBreadcrumbSchema([
  { name: 'Home', url: '/' },
  { name: 'Plant Rental', url: '/plant-rental' },
]);

const plantRentalServiceSchema = generateServiceSchema({
  name: 'Plant Rental Service',
  description:
    'Rent beautiful plants for events, offices, homes, and exhibitions with flexible durations, delivery, setup, and maintenance included.',
  areaServed: 'Bangalore',
  priceRange: '₹₹-₹₹₹',
});

const plantRentalFAQs = generateFAQSchema([
  {
    question: 'What types of plants can I rent?',
    answer:
      'We offer a wide variety of indoor plants, flowering plants, palms, succulents, and decorative foliage plants suitable for events, offices, and homes.',
  },
  {
    question: 'What is included in the plant rental service?',
    answer:
      'Our plant rental service includes delivery, professional setup, maintenance during the rental period, and pickup. We handle everything for you!',
  },
  {
    question: 'What is the minimum rental duration?',
    answer:
      'We offer flexible rental durations starting from single-day rentals for events to monthly rentals for offices and homes.',
  },
  {
    question: 'Do you deliver plants for events?',
    answer:
      'Yes! We provide delivery and setup for all events including weddings, corporate events, exhibitions, and parties across Bangalore.',
  },
]);
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(plantRentalBreadcrumbs),
        }}
      />
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(plantRentalServiceSchema),
        }}
      />
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(plantRentalFAQs) }}
      />
      ...
      {/* Plant Categories */}
      <section
        style={{ padding: '100px 0', backgroundColor: 'var(--bg-secondary)' }}
      >
        <div
          style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 24px' }}
        >
      ...
      <section style={{ padding: '100px 0', backgroundColor: 'white' }}>
        ...
        >
          ...
          >
            ...
            >
              Our rental service covers everything you need for a hassle-free
              experience.
            </p>
          </div>
      ...
      <section
        style={{ padding: '100px 0', backgroundColor: 'var(--primary-50)' }}
      >
        <div
          style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 24px' }}
        >
          ...
          <div style={{ marginBottom: '96px', textAlign: 'center' }}>
            ...
            <div className="relative">
              {/* Subtle line */}
              <div
                className="hidden lg:block absolute top-[20px] left-0 right-0 h-[2px] bg-[var(--primary-200)] w-[85%] mx-auto z-0"
                style={{ opacity: 0.5 }}
              />
                ...
                {[
                  {
                    ...
                    description:
                      'Fill out the inquiry form with your event details.',
                  },
                  {
                    step: '2',
                  ...
                  },
                  {
                    ...
                    title: 'Enjoy & pickup',
                    description:
                      "Use the plants, and we'll pick them up later.",
                  },
                ].map((item, index) => (
              ...
              {[
                {
                  ...
                  value:
                    'Daily, Weekly, and Monthly plans tailored to your specific timeline.',
                  icon: Calendar,
                },
                {
                  label: 'Minimum Order',
                  value:
                    '5 plants for events, 10 for offices. Custom packages available.',
                  icon: Store,
                },
                {
                  label: 'Service Area',
                  value:
                    'Bangalore and surrounding metro areas. Travel fees may apply for outskirts.',
                  icon: Truck,
                },
                {
                  label: 'Advance Notice',
                  value:
                    '2-3 days for small orders. 1 week for large events to ensure availability.',
                  icon: CheckCircle2,
                },
              ].map((info, idx) => {
      ...
      <section
        id="inquiry-form"
        style={{ padding: '100px 0', backgroundColor: 'var(--primary-900)' }}
      >
        <div
          style={{
            maxWidth: '1400px',
