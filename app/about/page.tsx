...
export const metadata: Metadata = {
  title: 'About Us | Your Trusted Gardening Partner in Bangalore',
  description:
    "Learn about My Garden Space - Bangalore's trusted partner for professional gardening and landscaping services. 10+ years experience, 500+ projects completed, 50+ expert gardeners, and 200+ happy clients.",
  keywords: [
    'about My Garden Space',
    'gardening company Bangalore',
    'landscaping experts',
    'professional gardeners',
    'garden designers Bangalore',
  ],
  openGraph: {
    title: 'About Us | My Garden Space',
    description:
      '10+ years of experience transforming outdoor spaces in Bangalore.',
    url: `${SITE_URL}/about`,
    type: 'website',
    images: [
      {
...
const aboutPageBreadcrumbs = generateBreadcrumbSchema([
  { name: 'Home', url: '/' },
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(aboutPageBreadcrumbs),
        }}
      />
      <script
        type="application/ld+json"
      ...
      {/* Our Values */}
      <section
        style={{ padding: '120px 0', backgroundColor: 'var(--bg-cream)' }}
      >
        <div
          style={{
            maxWidth: '1400px',
      ...
      {/* CTA Section */}
      <section
        style={{ padding: '100px 0', backgroundColor: 'var(--primary-950)' }}
      >
        <div
          style={{
            maxWidth: '1400px',
