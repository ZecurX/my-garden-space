...
export const metadata: Metadata = {
  title: 'Our Services | Professional Gardening & Landscaping',
  description:
    'Explore our comprehensive gardening and landscaping services in Bangalore. Garden maintenance, landscaping design, plant rental, vertical gardens, pergola installation, water features, and more. Get a free quote today!',
  keywords: [
  ...
  openGraph: {
    title: 'Our Services | My Garden Space',
    description:
      'Professional gardening and landscaping services in Bangalore. From maintenance to complete garden transformations.',
  ...
  twitter: {
    ...
    title: 'Our Services | My Garden Space',
    description:
      'Professional gardening and landscaping services in Bangalore.',
  },
  alternates: {
...
const servicesPageBreadcrumbs = generateBreadcrumbSchema([
  { name: 'Home', url: '/' },
...
const servicesListSchema = generateServicesListSchema([
  ...
  {
    name: 'Landscaping & Outdoor Development',
    description:
  ...
  {
    name: 'Irrigation & Smart Gardening',
    description:
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(servicesPageBreadcrumbs),
        }}
      />
      <script
        type="application/ld+json"
